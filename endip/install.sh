...
echo ""
echo -e "${Green}**********************${rest}"
echo -e "${Green}*  ${yellow}Ipv4 And Ipv6 Scanner ${Green} *${rest}"
echo -e "${Green}*  ${yellow}wire-g installer ${Green} *${rest}"
echo -e "${Green}*  ${yellow}License Generator ${Green}    *${rest}"
echo -e "${Green}**********************${rest}"
echo -e "${purple}[1] ${cyan}Create${green} IPV4${white}   * ${rest}"
echo -e "${purple}                     *${rest}"
echo -e "${purple}[2] ${cyan}Create${green} IPV6${white}   * ${rest}"
echo -e "${purple}                     *${rest}"
echo -e "${purple}[3] ${cyan}Config Gen${green}Wg${white} *${rest}"
echo -e "${purple}                     *${rest}"
echo -e "${purple}[4] ${cyan}Install ${green}wire-g${white}   *${rest}"
echo -e "${purple}                     *${rest}"
echo -e "${purple}[5] ${cyan}License Gen${Green}   *${rest}"
echo -e "${purple}                     *${rest}"
