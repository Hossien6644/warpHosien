...
echo ""
echo -e "${Green}**********************${rest}"
echo -e "${Green}*  ${yellow}Ipv4 Generator Pl${Green} *${rest}"
echo -e "${Green}*  ${yellow}wire-g installer ${Green} *${rest}"
echo -e "${Green}*  ${yellow}License Gen Pl${Green}    *${rest}"
echo -e "${Green}**********************${rest}"
echo -e "${purple}[1] ${cyan}Create Ip${green} IPV4${white}   * ${rest}"
echo -e "${purple}                     *${rest}"
echo -e "${purple}[2] ${cyan}Create Ip${green} IPV6${white}   * ${rest}"
echo -e "${purple}                     *${rest}"
echo -e "${purple}[3] ${cyan}Config Gen plu${green}Wg${white} *${rest}"
echo -e "${purple}                     *${rest}"
echo -e "${purple}[4] ${cyan}Install ${green}wire-g${white}   *${rest}"
echo -e "${purple}                     *${rest}"
echo -e "${purple}[5] ${cyan}License Generator plus${Green}   *${rest}"
echo -e "${purple}                     *${rest}"
echo -e "${purple}[${red}0${White}] Exit             *${rest}"
echo -e "${purple}**********************${rest}"
