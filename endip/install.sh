...
echo -e "${Green}**********************${rest}"
echo -e "${purple}[1] ${cyan}Create Ip${green} IPV4${Green}   * ${rest}"
echo -e "${purple}                     *${rest}"
echo -e "${purple}[2] ${cyan}Create Ip${green} IPV6${Green}   * ${rest}"
echo -e "${purple}                     *${rest}"
echo -e "${purple}[3] ${cyan}Config Gen plu${green}Wg${Green} *${rest}"
echo -e "${purple}                     *${rest}"
echo -e "${purple}[4] ${cyan}Install ${Yellow}wire-g${Green}   *${rest}"
echo -e "${purple}                     *${rest}"
echo -e "${purple}[5] ${cyan}License GenPl${Green}   *${rest}"
echo -e "${purple}                     *${rest}"
echo -e "${purple}[${red}0${Green}] Exit             *${rest}"
echo -e "${purple}**********************${rest}"
